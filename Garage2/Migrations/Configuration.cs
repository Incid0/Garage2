	...
	internal sealed class Configuration : DbMigrationsConfiguration<Garage2.DataLayer.VehiclesDB>
	{
		...
		protected override void Seed(Garage2.DataLayer.VehiclesDB context)
		{
			...
			context.Vehicles.AddOrUpdate(
				...
				new Vehicle { RegNr = "ZOO123", Type = VehicletypesEnum.Motorcykel, Brand = "Yamaha", Model = "CR80", Color = "Röd", Wheels = 2, EntryTime = DateTime.Now - TimeSpan.FromSeconds(rng.Next(604800)) },
				new Vehicle { RegNr = "TXT000", Type = VehicletypesEnum.Båt, Brand = "Otter", Model = "T500", Color = "Orange", Wheels = 0, EntryTime = DateTime.Now - TimeSpan.FromSeconds(rng.Next(604800)) },
				...
				new Vehicle { RegNr = "POT789", Type = VehicletypesEnum.Lastbil, Brand = "Volvo", Model = "R10", Color = "Blå", Wheels = 18, EntryTime = DateTime.Now - TimeSpan.FromSeconds(rng.Next(604800)) }
			);
		}
	}
}
